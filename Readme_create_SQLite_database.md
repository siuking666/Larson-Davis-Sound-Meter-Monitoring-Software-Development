...
- Existing database of the same name will not be overwritten
- For the live monitoring data database, the table is structured as follows:
    - Table name: Measurements; the name is NOT case sensitive unless double quoted
...
- For the exported data database, the table is structured as follows:
    ...
    ### Currently only the live monitoring one is finished
